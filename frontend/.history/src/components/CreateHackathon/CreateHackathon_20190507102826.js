...
class CreateHackathon extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.auth.user !== undefined) {
      component.setState({ user: this.props.auth.user }, function() {
        console.log("User1");
    ...
    component.setState({ eventName: "Kriti Hackathon" });
    ...
    this.setState(
      ...
      function() {
        ...
        this.setState({ judges: newArray }, function() {
          console.log("Within");
          console.log(this.state.judges);
        });
      }
  ...
  addjudge = e => {
    console.log("After adding" + e);
    this.setState({ judge_select: [...e] }, function() {
      debugger;
      console.log("selected judge:" + this.state.judge_select);
      console.log("selected judge:" + this.state.judges);
    });
  };
